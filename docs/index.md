...
- **`user-guide.md`** — Settings User's Guide and Help pop-ups. On the Settings page and in Help. Options, Delete, Save, Done, Snooze, Banners, and Log are in. There is no Reset All Data.
