...
- **`designed-implementation.md`** — the whole-app guide. A sitting builds from it and does not ask Patrick a design question. Home, Help, Calendar, Settings, Backup, Scheduled Reminders, and Options are in it. #87-new: banner housing is built. Siri is out of sight.
