...
- **`handoff.md`** — the opening read. Where the work stands and what is open. Phone load 90. #115-new closed. The Quarterly day-chip and weekday-pattern conflict is next.
...
- **`in-flight.md`** — this session's desk. Replaced every time, never added to. Last written #115-new, session close.
