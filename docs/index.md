...
- **`designed-implementation.md`** — the whole-app guide. A sitting builds from it and does not ask Patrick a design question. Home and Help are in it. #87-new: banner housing is built. Siri is out of sight.
